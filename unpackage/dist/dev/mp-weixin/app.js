...
if (!Math) {
  ...
  "./pages/pay/pay.js";
  "./pages/vedioDetail/vedioDetail.js";
  "./pages/vedioPlayer/vedioPlayer.js";
  "./pages/indexPlayer/indexPlayer.js";
  "./pages/control/control.js";
  "./pages/cutDetail/cutDetail.js";
  "./pages/cutShare/cutShare.js";
  "./pages/cutPlayer/cutPlayer.js";
  "./pages/downLoad/downLoad.js";
  "./pages/smallVedio/smallVedio.js";
  "./pages/payForExtend/payForExtend.js";
  "./pages/cutVideo/cutVideo.js";
  "./pages/refund/refund.js";
  "./pages/afterCutShare/afterCutShare.js";
...
const _sfc_main = {
  ...
  onShow: async function() {
    const result = await request_api.getProjectList();
    const list = result.item.project.filter((item) => {
      return item.status == "idle" || item.status == "ready";
    });
    common_vendor.index.setStorageSync("list", list);
    const project = {
      id: "",
      name: ""
    };
    common_vendor.index.setStorageSync("project", project);
  },
  onHide: function() {
...
function createApp() {
  ...
  let http = require("./request/request");
  common_vendor.index.$u.htpp = http.http;
  return {
    app
  };
}
