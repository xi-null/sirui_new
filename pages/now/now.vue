...
<script>
	export default{
		data(){
			return {
			src:`https://h5-1259813764.cos.ap-nanjing.myqcloud.com/now_new_1.html?userId=${uni.getStorageSync('user').id}`,
		...
		onLoad(query){
			...
			if(query.scene==undefined){
				...
				this.src = `https://h5-1259813764.cos.ap-nanjing.myqcloud.com/now_new_1.html?userId=${uni.getStorageSync('user').id}&projectId=${query.scene}`
